...
export default function StudentDashboard() {
  ...
  <div className="w-full max-w-5xl bg-white rounded-sm border-1 border-gray-300 p-10 space-y-8">
    ...
    {/* Info Note */}
    <div className="flex items-start gap-3 bg-blue-50 border-2 border-blue-500 rounded-lg p-4">
      <InfoOutlined className="text-blue-500 mt-1" />
      <p className="text-sm text-blue-600">
        <strong>Note:</strong> Your subscription will expire soon. Please renew before the due date to avoid service interruption.
      </p>
    </div>
  </div>
</div>
