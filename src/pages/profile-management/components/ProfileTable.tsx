...
export default function ProfileTable() {
  ...
  const filteredStudents = students.filter((student) => {
    ...
    const matchesCategory =
      selectedCategory === "All" || student.subscription_type?.name === selectedCategory;
  ...
  return (
    <Box width="100%" border={1} borderColor="#e0e0e0" overflow="hidden" borderRadius={1} bgcolor="#fafafa">
      <TableContainer component={Paper} elevation={0}>
        <Table>
          <TableHead sx={{ bgcolor: "#f0f0f0" }}>
            <TableRow>
              {["Name", "Address", "Age", "Category", "Date Created", "Paid Until", "Action"].map((label, idx) => (
          ...
          <TableBody>
            {paginatedStudents.map((student) => {
              const isMonthly = student.subscription_type?.name === "monthly";
              const subscriptionDate = student.created_at;
              const paymentStatus = isMonthly && student.paid_until ? student.paid_until : "-";
              ...
              return (
                <TableRow key={student.id} hover>
                  ...
                  <TableCell>{paymentStatus!== "-" ? new Date(paymentStatus).toLocaleDateString("en-US", {
                          year: "numeric",
                          month: "short",
                          day: "numeric",
                        }): "N/A"}</TableCell>
